  ...
  return (
    <Card className="w-full rounded-[25px] border-0 outline-none shadow-none">
      <CardContent className="pt-6">
        <div
          role="img"
          aria-label="Weekly activity chart showing deposits and withdrawals for each day of the week"
          className="h-[180px] sm:h-[200px] md:h-[226px]"
        >
        ...
        <div className="flex items-center justify-center sm:justify-end gap-4 sm:gap-6 md:gap-8 mt-4 sm:mt-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs sm:text-sm md:text-[15px] text-neutral-30">Deposit</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-red-50" />
            <span className="text-xs sm:text-sm md:text-[15px] text-neutral-30">Withdraw</span>
          </div>
        </div>
      </CardContent>
    </Card>
